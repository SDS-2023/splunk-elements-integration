...
# from elementssecuritycenter_consts import *
import requests
import json
...
class ElementsSecurityCenterConnector(BaseConnector):

    def __init__(self):

        # Call the BaseConnectors init first
        super(ElementsSecurityCenterConnector, self).__init__()
...
def main():
    ...
    if username and password:
        try:
            login_url = ElementsSecurityCenterConnector._get_phantom_base_url() + '/login'
    ...
    with open(args.input_test_json) as f:
        ...
        connector = ElementsSecurityCenterConnector()
